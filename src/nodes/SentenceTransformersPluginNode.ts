...
export type SentenceTransformersPluginNode = ChartNode<
  "sentenceTransformersPluginNode",
  SentenceTransformersPluginNodeData
>;

// This defines the data that your new node will store.
export type SentenceTransformersPluginNodeData = {
  embeddings: number[];
  strArray: string[];
...
export function sentenceTransformersPluginNode(rivet: typeof Rivet) {
  // This is your main node implementation. It is an object that implements the PluginNodeImpl interface.
  const SentenceTransformersPluginNodeImpl: PluginNodeImpl<SentenceTransformersPluginNode> =
    {
      // This should create a new instance of your node type from scratch.
      create(): SentenceTransformersPluginNode {
        const node: SentenceTransformersPluginNode = {
      ...
      getInputDefinitions(
        data: SentenceTransformersPluginNodeData,
      ...
      getOutputDefinitions(
        _data: SentenceTransformersPluginNodeData,
        _connections: NodeConnection[],
        _nodes: Record<NodeId, ChartNode>,
        _project: Project,
      ): NodeOutputDefinition[] {
      ...
      getEditors(
        _data: SentenceTransformersPluginNodeData,
      ): EditorDefinition<SentenceTransformersPluginNode>[] {
        return [
          {
            type: "stringList",
            dataKey: "strArray",
      ...
      async process(
        ...
        const sentenceTransformers = await SentenceTransformer.from_pretrained(
